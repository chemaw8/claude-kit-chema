...
| C.A.4 | Instalador: HOME limpio instala todo; con CLAUDE.md previo no pisa; actualiza solo su sección | Cumplido | Instalador probado hoy en 3 escenarios (limpio, con CLAUDE.md previo, re-ejecución) + `KIT_HOOKS=s`; ver tests re-corridos en la bitácora de la sesión de construcción 2026-07-09 (journal `wf_21c2505a-8ed`) |
